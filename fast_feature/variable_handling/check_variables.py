...
def check_numerical_variables(
    ...
    --------
    >>> import pandas as pd
    >>> from fast_feature.variable_handling import check_numerical_variables
    >>> X = pl.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
...
def check_categorical_variables(
    ...
    --------
    >>> import pandas as pd
    >>> from fast_feature.variable_handling import check_categorical_variables
    >>> X = pl.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
...
def check_datetime_variables(
    ...
    --------
    >>> import pandas as pd
    >>> from fast_feature.variable_handling import check_datetime_variables
    >>> X = pl.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
...
def check_all_variables(
    ...
    --------
    >>> import pandas as pd
    >>> from fast_feature.variable_handling import check_all_variables
    >>> X = pl.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
