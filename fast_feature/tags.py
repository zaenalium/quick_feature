def _return_tags():
    return {
        ...
        "_xfail_checks": {
            ...
            "check_dtype_object": "fast_feature transformers use dtypes to select "
            "between numerical and categorical variables. fast_feature trusts the "
            ...
            "check_fit2d_predict1d": "Test not relevant, fast_feature transformers "
