...
def check_X(X: Union[np.generic, np.ndarray, pl.DataFrame, pd.DataFrame]) -> pl.DataFrame:
    ...
    fast_feature was originally designed to work with polars or pandas dataframes. However,
    ...
    fast_feature transformers can be used within a Scikit-learn Pipeline together
