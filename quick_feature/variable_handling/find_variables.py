...
def find_numerical_variables(X: pl.DataFrame) -> List[Union[str, int]]:
    ...
    --------
    >>> import polars as pl
    >>> from quick_feature.variable_handling import find_numerical_variables
    >>> X = pd.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
...
def find_categorical_variables(X: pl.DataFrame) -> List[Union[str, int]]:
    ...
    --------
    >>> import polars as pl
    >>> from quick_feature.variable_handling import find_categorical_variables
    >>> X = pd.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
...
def find_datetime_variables(X: pl.DataFrame) -> List[Union[str, int]]:
    ...
    --------
    >>> import polars as pl
    >>> from quick_feature.variable_handling import find_datetime_variables
    >>> X = pd.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
...
def find_all_variables(
    ...
    --------
    >>> import polars as pl
    >>> from quick_feature.variable_handling import find_all_variables
    >>> X = pd.DataFrame({
    >>>     "var_num": [1, 2, 3],
    >>>     "var_cat": ["A", "B", "C"],
    >>>     "var_date": pd.date_range("2020-02-24", periods=3, freq="T")
...
def find_categorical_and_numerical_variables(
    ...
    --------
    >>> import pandas as pd
    >>> from quick_feature.variable_handling import (
