...
from quick_feature.dataframe_checks import _check_X_matches_training_df, check_X
from quick_feature.tags import _return_tags
from quick_feature.variable_handling import (
    check_numerical_variables,
    find_numerical_variables,
)
from quick_feature.variable_handling.check_variables import check_all_variables
from quick_feature.variable_handling.find_variables import find_all_variables
import polars as pl
...
class SklearnTransformerWrapper(BaseEstimator, TransformerMixin):
    ...
    Pipeline and returns polars or pandas dataframes.
    ...
    def fit(self, X: pl.DataFrame, y: Optional[str] = None):
        """
