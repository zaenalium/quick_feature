...
from quick_feature.dataframe_checks import _check_contains_na, check_X_y
...
from quick_feature.encoding.ordinal import OrdinalEncoder
...
class DecisionTreeEncoder(CategoricalInitMixin, CategoricalMethodsMixin):
    ...
    quick_feature.discretisation.DecisionTreeDiscretiser
    quick_feature.encoding.RareLabelEncoder
    quick_feature.encoding.OrdinalEncoder
