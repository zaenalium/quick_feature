def _return_tags():
    return {
        ...
        "_xfail_checks": {
            ...
            "check_dtype_object": "quick_feature transformers use dtypes to select "
            "between numerical and categorical variables. quick_feature trusts the "
            ...
            "check_fit2d_predict1d": "Test not relevant, quick_feature transformers "
